...
class FantasyDataManager:
    ...
    def _preprocess_data(self):
        ...
        try:
            ...
            self.data["player_name"] = (
                self.data["player_name"].str.replace(" ", "").str.lower()
            )
            ...
            self.data["rank_ecr"] = pd.to_numeric(
                self.data["rank_ecr"], errors="coerce"
            )

            # Remove rows with NaN values in critical columns
            self.data = self.data.dropna(
                subset=["player_name", "team", "salary", "projected_points"]
            )
    ...
    def _validate_data(self) -> bool:
        ...
        invalid_positions = (
            set(self.data["player_position_id"].unique()) - self.config.VALID_POSITIONS
        )
        ...
        for i, player1 in enumerate(players):
            for j, player2 in enumerate(players):
                if i == j:
                    ...
                    pos1 = team_data[team_data["player_name"] == player1][
                        "player_position_id"
                    ].iloc[0]
                    pos2 = team_data[team_data["player_name"] == player2][
                        "player_position_id"
                    ].iloc[0]
                    ...
                    if pos1 == "QB" and pos2 in ["WR", "TE"]:
                        ...
                        corr_matrix.loc[player1, player2] = (
                            -0.1
                        )  # Slight negative correlation
                    else:
                        corr_matrix.loc[player1, player2] = (
                            0.1  # Slight positive correlation
                        )
    ...
    def get_data_summary(self) -> dict:
        ...
        return {
            ...
            "players_by_position": self.data["player_position_id"]
            .value_counts()
            .to_dict(),
            "salary_stats": {
